...
function getClients()
{
	...
	function(data) {
		...
		{	
			inner_html += "<td><a href='#' id='client_"+i+"' onclick='loadClient(\""+data.clients[i].name+"\");'>"+data.clients[i].name+"</a></td>";
			...
			inner_html += "<td align='center'><img src='img/delete.png' width='20' heigth='20' alt='Eliminar' title='Eliminar' /></td></tr>";
		}
