        ...
        jQuery.fn.html5_upload = function(options) {
                ...
                function upload() {
                        ...
                        function upload_file(number) {
                                ...
                                /* To implement the 'sendBoundary' option, prefer using the FormData() API
                                 * over file.getAsBinary() because the latter has to read the whole file into memory */
                                if (window.FormData) {
                                        var f = new FormData();
                                        ...
                                        alert("jquery.html5_upload: your browser doesn't support " +
                                                  "the requested 'sendBoundary' option. Please call " +
                                                  "html5_upload() with 'sendBoundary' set to false and change " +
