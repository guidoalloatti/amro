...
void ChemicalAnalysis::setTermicalTreatment(TermicalTreatment tt) {
    this->termicalTreatment = tt;
}
...
TermicalTreatment ChemicalAnalysis::GetTermicalTreatment() const
{
    return this->termicalTreatment;
}
